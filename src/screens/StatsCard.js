...
const StatsCard = (props) => {
    return (
        <View style={styles.statscard}>
            <View style={{ justifyContent: "space-between", flexDirection: 'column', alignItems: "center", height: 120 }}>
                <Text style={{ color: "grey", fontSize: 14 }}>Your Location is</Text>
                <Text style={{ fontSize: 54, fontWeight: "900", letterSpacing: 0 }}>{props.data.statename}</Text>
